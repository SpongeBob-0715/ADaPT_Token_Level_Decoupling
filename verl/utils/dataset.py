...
class RLHFDataset(Dataset):
    ...
    def _build_messages(self, example: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        if self.image_key in example:
            ...
            return [{"role": "system", "content": "Please reason step by step, for difficult questions, output <think> and engage long thinking mode. For simple questions, output <answer> and engage short thinking mode. Provide your final answer within \boxed{}."},
